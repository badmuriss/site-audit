...
Document which surfaces are seasoning-sensitive in the project's agent instructions file (`AGENTS.md`, or `CLAUDE.md` on Claude Code) so future audits know where to escalate.
