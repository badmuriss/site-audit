...
Beyond the stress table in [ux-walkthrough.md](ux-walkthrough.md) section 8, these recipes catch the failure modes that scenarios miss. Each recipe has a how-to, what-it-catches, and severity guide.
